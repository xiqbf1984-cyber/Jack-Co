...
export const CAREER_CLUSTER_GROUPS = [
  { name: 'Connecting & Supporting Success', ids: ['digital-technology', 'management-entrepreneurship', 'marketing-sales'] },
  { name: 'Investing in the Future', ids: ['financial-services'] },
  { name: 'Building & Moving', ids: ['advanced-manufacturing', 'construction', 'supply-chain'] },
  { name: 'Creating & Experiencing', ids: ['arts-entertainment', 'hospitality'] },
  { name: 'Caring for Communities', ids: ['education', 'healthcare', 'public-service'] },
  { name: 'Cultivating Resources', ids: ['agriculture', 'energy'] },
];
...
export const MOCK_ROLES = [
  { id: 1, title: 'AI Research Engineer', dept: 'Research', status: 'active', salary: '$180k-$250k', createdAt: '2025-03-15T10:00:00Z', isPrivate: false, jd: 'We are looking for an AI Research Engineer to design and build frontier AI systems. You will lead large-scale ML experiments, develop novel model architectures, and collaborate with cross-functional teams to bring research breakthroughs into production. Requirements: PhD or MS in ML/AI, 3+ years experience with large-scale training, proficiency in PyTorch and distributed computing.' },
  { id: 2, title: 'ML Platform Engineer', dept: 'Infrastructure', status: 'active', salary: '$160k-$220k', createdAt: '2025-03-10T14:30:00Z', isPrivate: false, jd: 'We are hiring an ML Platform Engineer to build and maintain scalable ML infrastructure. You will design CI/CD pipelines for model training and deployment, optimize GPU clusters, and create developer tools that accelerate the ML lifecycle. Requirements: 3+ years in infrastructure/DevOps, experience with Kubernetes, and familiarity with ML frameworks.' },
  { id: 3, title: 'AI Product Manager', dept: 'Product', status: 'draft', salary: '$150k-$200k', createdAt: '2025-02-20T09:00:00Z', isPrivate: false, jd: 'We are seeking an AI Product Manager to drive the strategy and roadmap for our AI-powered products. You will translate business requirements into technical specifications, prioritize features based on user research, and work closely with engineering to ship impactful AI features. Requirements: 4+ years in product management, strong technical background, experience shipping ML-powered products.' },
];

export const MOCK_CANDIDATES = [
  { id: 1, name: 'Alex Chen', email: 'alex@gmail.com', status: 'active', tz: 'PST', joined: 'Dec 2', avatar: 'AC', assessments: 3, lastActive: '2 hours ago' },
  { id: 2, name: 'Sarah Kim', email: 'sarah@outlook.com', status: 'completed', tz: 'EST', joined: 'Dec 5', avatar: 'SK', assessments: 2, lastActive: '1 day ago' },
  { id: 3, name: 'James Liu', email: 'jliu@pm.me', status: 'idle', tz: 'CST', joined: 'Dec 10', avatar: 'JL', assessments: 1, lastActive: '5 days ago' },
  { id: 4, name: 'Priya Patel', email: 'priya@co.com', status: 'active', tz: 'IST', joined: 'Dec 12', avatar: 'PP', assessments: 4, lastActive: '3 hours ago' },
];

export const MOCK_ASSESSMENTS = [
  {
    id: 'c1', name: 'LLM Fine-tuning', roleId: 1, roleTitle: 'AI Research Engineer',
    status: 'published', skill: 'Fine-tuning & RLHF', task: 'Implementation task', createdAt: '2025-03-20T08:00:00Z',
    candIds: [1, 2],
    results: [
  ...
  },
  {
    ...
    status: 'submitted', skill: 'Model Architecture', task: 'Design task', createdAt: '2025-03-18T11:00:00Z',
    candIds: [1],
    results: [
  ...
  },
  {
    ...
    status: 'published', skill: 'CI/CD for ML', task: 'Build task', createdAt: '2025-03-12T15:00:00Z',
    candIds: [3, 4],
    results: [
...
export const SEARCH_CATEGORIES = [
  { label: 'Role', opts: [
    { label: 'AI Research Engineer', prompt: 'AI Research Engineer — designing and building frontier AI systems for large-scale ML experiments' },
    { label: 'ML Platform Engineer', prompt: 'ML Platform Engineer — building infrastructure for model training, serving, and monitoring at scale' },
    { label: 'AI Product Manager', prompt: 'AI Product Manager — bridging technical AI capabilities with business outcomes and user needs' },
    { label: 'Data Scientist', prompt: 'Senior Data Scientist — experiment design, causal inference, and predictive modeling' },
    { label: 'NLP Engineer', prompt: 'NLP Engineer — building natural language processing systems and large language model applications' },
    { label: 'AI Safety Researcher', prompt: 'AI Safety Researcher — alignment research, red-teaming, and responsible AI development' },
    { label: 'Computer Vision Engineer', prompt: 'Computer Vision Engineer — image recognition, object detection, and visual AI systems' },
  ]},
  { label: 'Level', opts: [
    { label: 'Junior (1-3 years)', prompt: 'Junior level, 1-3 years of experience' },
    { label: 'Mid-level (3-5 years)', prompt: 'Mid-level, 3-5 years of experience' },
    { label: 'Senior (5-8 years)', prompt: 'Senior level, 5-8 years of experience' },
    { label: 'Staff / Principal (8+ years)', prompt: 'Staff or Principal level, 8+ years of deep expertise' },
    { label: 'Lead / Manager', prompt: 'Technical Lead or Engineering Manager with team leadership experience' },
  ]},
  { label: 'Skills', opts: [
    { label: 'Python & PyTorch', prompt: 'Strong Python and PyTorch deep learning skills' },
    { label: 'LLM & Prompt Engineering', prompt: 'LLM fine-tuning, RLHF, and prompt engineering' },
    { label: 'System Design', prompt: 'Distributed systems design for ML at scale' },
    { label: 'Data Engineering', prompt: 'Data pipeline architecture and optimization' },
    { label: 'MLOps & CI/CD', prompt: 'ML deployment, monitoring, and CI/CD pipelines' },
    { label: 'Cloud Infrastructure', prompt: 'AWS, GCP, or Azure cloud infrastructure and Kubernetes' },
  ]},
  { label: 'Location', opts: [
    { label: 'Fully Remote (Worldwide)', prompt: 'Fully remote, open to candidates worldwide' },
    { label: 'Remote (US only)', prompt: 'Remote, US-based candidates only' },
    { label: 'San Francisco Bay Area (Hybrid)', prompt: 'San Francisco Bay Area, hybrid 2-3 days onsite' },
    { label: 'New York City (Hybrid)', prompt: 'New York City, hybrid schedule' },
    { label: 'London, UK', prompt: 'London, UK — onsite or hybrid' },
    { label: 'Berlin, Germany', prompt: 'Berlin, Germany — onsite or hybrid' },
    { label: 'Singapore', prompt: 'Singapore — onsite or hybrid' },
    { label: 'Toronto, Canada', prompt: 'Toronto, Canada — hybrid or remote' },
  ]},
];
...
export const SIDEBAR_NAV = [
  ...
  { id: 'assessments', label: 'Assessments', icon: 'ClipboardList', href: '/assessment' },
...
export const WIZARD_STEPS = [
  ...
  { id: 'task', label: 'Task', index: 1 },
  { id: 'context', label: 'Problem', index: 2 },
  { id: 'environment', label: 'Environment', index: 3 },
  { id: 'rubrics', label: 'Rubrics', index: 4 },
