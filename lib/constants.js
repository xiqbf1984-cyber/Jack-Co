...
export const MOCK_CANDIDATES = [
  { id: 1, name: 'Alex Chen', email: 'alex@gmail.com', status: 'active', tz: 'PST', joined: 'Dec 2', avatar: 'AC' },
  { id: 2, name: 'Sarah Kim', email: 'sarah@outlook.com', status: 'completed', tz: 'EST', joined: 'Dec 5', avatar: 'SK' },
  { id: 3, name: 'James Liu', email: 'jliu@pm.me', status: 'idle', tz: 'CST', joined: 'Dec 10', avatar: 'JL' },
  { id: 4, name: 'Priya Patel', email: 'priya@co.com', status: 'active', tz: 'IST', joined: 'Dec 12', avatar: 'PP' },
];
...
export const ROLE_CREATION_QUESTIONS = [
  ...
  { id: 'skills', question: 'Most important skills?', chips: ['Python/PyTorch', 'Research', 'System design', 'Product sense', '5+ years ML'] },
  { id: 'level', question: 'Experience level?', chips: ['Junior', 'Mid', 'Senior', 'Staff+'] },
  { id: 'extra', question: 'Remote policy, comp?', chips: ['Remote', 'Hybrid', '$150-250k', '$250k+'] },
];

export const SEARCH_CATEGORIES = [
  { label: 'Role', icon: 'Briefcase', opts: [
  ...
  { label: 'Level', icon: 'BarChart3', opts: [
    { label: 'Junior', prompt: 'Junior, 1-3 years' },
    { label: 'Mid', prompt: 'Mid, 3-5 years' },
    { label: 'Senior', prompt: 'Senior, 5+ years' },
    { label: 'Staff+', prompt: 'Staff/Principal level' },
  ]},
  { label: 'Skills', icon: 'Target', opts: [
    { label: 'PyTorch', prompt: 'Strong PyTorch skills' },
    { label: 'LLM', prompt: 'LLM fine-tuning and RLHF' },
    { label: 'System Design', prompt: 'Distributed systems for ML' },
  ]},
  { label: 'Location', icon: 'MapPin', opts: [
    { label: 'Remote', prompt: 'Fully remote' },
    { label: 'SF', prompt: 'San Francisco hybrid' },
    { label: 'NYC', prompt: 'New York' },
  ]},
];

export const SEMANTIC_PILLS = [
  { key: 'role', label: 'Role', keywords: ['engineer', 'scientist', 'manager', 'developer', 'researcher'] },
  { key: 'skills', label: 'Skills', keywords: ['python', 'pytorch', 'ml', 'nlp', 'llm', 'kubernetes'] },
  { key: 'exp', label: 'Experience', keywords: ['junior', 'senior', 'staff', 'years', 'mid'] },
  { key: 'loc', label: 'Location', keywords: ['remote', 'hybrid', 'sf', 'nyc', 'london'] },
  { key: 'comp', label: 'Compensation', keywords: ['salary', '$', 'equity', '150k', '250k'] },
];
...
export const SIDEBAR_NAV = [
  ...
  { id: 'assessment', label: 'Assessment', icon: 'Trophy', href: '/assessment' },
